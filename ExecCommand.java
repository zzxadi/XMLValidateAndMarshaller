...
public class ExecCommand {
	...
	public static void main(String[] args) {
		...
		for (String str : list) {
			if (str != null && str.length() == 3 && (Integer.valueOf(str) == 122 || Integer.valueOf(str) == 143 || Integer.valueOf(str) == 743 || Integer.valueOf(str) == 745)) {
				System.out.println(execCommand("xjc -p com.cqfc.xmlparser.transactionmsg"+str+" -d ../java transdef"+str+".xsd"));;
			}
		}
